...
<div bind:clientHeight={height} class="bg-background h-16 border-b border-text/20 sm:hidden flex top-0 fixed w-screen z-[60] px-2 transition-colors justify-between cursor-pointer pt-2 text-black">
